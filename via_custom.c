...
void basic_config_set_value( uint8_t *data )
{
    ...
    switch ( *value_id )
    {
        ...
        case id_caps_twinkle:
        {
            user_config.caps_twinkle = *value_data;
            break;
        }
        case id_caps_color:
        {
            user_config.caps_hue = value_data[0];
            break;
        }
...
void basic_config_get_value( uint8_t *data )
{
    ...
    switch ( *value_id )
    {
        ...
        case id_caps_flash_enabled:
        {
            if (user_config.caps_flash_enabled) {
                *value_data = true;
            } else {
                *value_data = false;
            }
        ...
        case id_caps_color:
        {
            value_data[0] = user_config.caps_hue;
            value_data[1] = 255;
            break;
        }
        case id_repeat_numbers:
