...
#define NUM_REPEATS   KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_GRV,\
                      KC_8, KC_9, KC_0, KC_EQL, KC_MINS, KC_BSPC
#define MOD_REPEATS   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7,\
                      KC_TAB, KC_ESC, KC_CAPS, KC_SPC,\
...
bool check_repeat_layer(void){
    for (uint8_t i = STARTING_GAMING_LAYER; i < ENDING_GAMING_LAYER; i++) {
        if (IS_LAYER_ON(i)) {
            return true;
        }
    }
...
bool is_repeat_key(uint16_t keycode){
